...
class Swiper extends Component {
  ...
  onPanResponderMove = (event, gestureState) => {
    ...
    try{
      // wrong Animate.event doesnt return an instance or it doesnt return a function so you cannot do a function call on returned Animate.event value as per React Native 0.63
    ...
    return (
      <View
        ...
        style={[
          styles.container,
          {
            overflow: useViewOverflow ? 'hidden' : 'visible',
